    ...
    function Canvas(props) {
            ...
            c.addEventListener("mousedown", function (e) {
                ...
                switch (_this.props.selectedControl) {
                    case _constants.ControlsEnum.grab:
                        var hightlightNodeID = _this.state.hightlightNodeID;
                ...
                switch (_this.props.selectedControl) {
                    case _constants.ControlsEnum.grab:
                        ...
                        if (!_this.state.mousedown) {
                            var _nearestNode = _this.getNearestNode(mousePosition, 5, _this.props.nodes);
                            _this.setState({
                                hightlightNodeID: _nearestNode ? _nearestNode.id : null
                            });
                        }
                        break;
                    case _constants.ControlsEnum.pan:
                    ...
                    case _constants.ControlsEnum.erase:
                        if (_this.state.mousedown) {
                            ...
                            var _nearestNode2 = _this.getNearestNode(mousePosition, 5, _this.props.nodes);
                            _this.setState({
                                hightlightNodeID: _nearestNode2 ? _nearestNode2.id : null
                            });
                        }
                        break;
                    case _constants.ControlsEnum.rope:
        ...
        _this.draw = function () {
            ...
            var drawLine = function drawLine(node, nodes, connectedNodeID) {
                ctx.beginPath();
                if (node.id === _this.state.hightlightNodeID) {
